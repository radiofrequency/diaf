...
import com.lols.diaf.entity.Anvil;
import com.lols.diaf.entity.Bed;
import com.lols.diaf.entity.Chest;
import com.lols.diaf.entity.Furnace;
import com.lols.diaf.entity.Lantern;
import com.lols.diaf.entity.Oven;
...
public class Crafting {
	...
	static {
		try {
			...
			workbenchRecipes.add(new FurnitureRecipe(Bed.class).addCost(Resource.wood, 1).addCost(Resource.cloth, 1).addCost(Resource.feather, 1));
			...
			ovenRecipes.add(new ResourceRecipe(Resource.bacon).addCost(Resource.pork, 4));
			ovenRecipes.add(new ResourceRecipe(Resource.patty).addCost(Resource.beef, 2));
			ovenRecipes.add(new ResourceRecipe(Resource.burger)
							.addCost(Resource.patty, 1).addCost(Resource.bread, 1).addCost(Resource.bacon, 1));
			
			ovenRecipes.add(new ResourceRecipe(Resource.pizza)
			.addCost(Resource.beef, 2).addCost(Resource.bacon, 2).addCost(Resource.bread, 2));
