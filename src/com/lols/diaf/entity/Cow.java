...
public class Cow extends Mob {
	...
	public void render(Screen screen) {
		...
		int col1 = Color.get(-1, 100,523, 555);
	...
	protected void die() {
		...
		for (int i = 0; i < count; i++) {
			level.add(new ItemEntity(new ResourceItem(Resource.beef), x + random.nextInt(11) - 5, y + random.nextInt(11) - 5));
		}
	}
