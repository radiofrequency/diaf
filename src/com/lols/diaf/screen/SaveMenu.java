...
public class SaveMenu extends Menu {
	...
	public SaveMenu(Menu parent, Activity mContext) {
		this.parent = parent;
	...
	public void render(Screen screen) {
		...
		//Font.draw("Load ", screen, (screen.w - msg.length() * 8) / 2, (8 + i) * 8, col);

		Font.draw("Save Game", screen, (screen.w - "Save Game".length() * 8) /2, 64-16, Color.get(0,555,555,555));
